...
$sjh= mysqli_query($koneksi, "SELECT * FROM tbl_sejarah");
$dg= mysqli_query($koneksi, "SELECT * FROM tbl_data_guru");
 ?>
<!doctype html>
<html lang="en">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 text-center">
                    <img class="img-fluid" src="img/profil.jpg" alt="mtsnaca">
                </div>

                <div class="offset-lg-1 col-lg-5">
                    <div class="dpmt_right"><div class="text-center">
                        <h1>Profil</h1>
                        </div>
                         <div class="text-center">
        <a class="btn primary-btn"  data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" style="color: white">Klik disisni</a>
    </div>

      </p>
    <div class="collapse" id="collapseExample">
<?php $sejarah =mysqli_fetch_assoc($sjh); ?>
      <div class="text-center">
    ...
    <div class="popular_courses lite_bg">
        <div class="container">
            ...
            <div class="row">
                <!-- single course -->
                    <?php while($data_guru =mysqli_fetch_assoc($dg)):  ?> 
                <div class="col-lg-3 col-md-6">
                    <div class="single_course">
                        <div class="course_head overlay">
                            <img class="img-fluid w-100" src="backend/img/<?=$data_guru['foto']; ?>" width='180' height='150'>
                        </div>
                        <div class="course_content">
                            <h4>
                                <a href="#"><?=$data_guru['nama']; ?></a>
                            </h4>
                            <p><?=$data_guru['pelajaran']; ?>.</p>
