<?php   
include 'config.php'; 
$kegiatan_sekolah= mysqli_query($koneksi, "SELECT * FROM tbl_kegiatan_sekolah");
...
<body class="body">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            ...
                            <p>Kegiatan Sekolah MTs Nasyatul Khair</p>
    ...
    <div class="popular_courses lite_bg">
        <div class="container">
            ...
            <div class="row">
                <!-- single course -->
<?php while($kegiatan_sekolah1 =mysqli_fetch_assoc($kegiatan_sekolah)):  ?> 

                <!-- single course -->
                <div class="col-lg-3 col-md-6">
                    <div class="single_course">
                        <div class="course_head overlay">
                            <img class="img-fluid w-100" src="backend/img/<?=$kegiatan_sekolah1['foto']; ?>" width='180' height='150'>
                            
                        </div>
                        <div class="course_content">
                            <h4>
                                <a href="#"><?=$kegiatan_sekolah1['judul']; ?></a>
                            </h4>
                            <p><?=$kegiatan_sekolah1['keterangan']; ?></p>
