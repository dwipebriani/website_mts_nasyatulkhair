     ...
     <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="pegumuman.php">Pengumuman</a>
              ...
              <div class="table-responsive">
                ...
                <?php   
                 include '../config.php';
                  ...
                  $tampil = mysqli_query($koneksi, "SELECT * FROM tbl_kegiatan_sekolah"); ?>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                   ...
                   <div class="text-left">
                  <a href="proses-tambah/tambah_kegiatan_sekolah.php" class="btn btn-primary">[+]Tambah kegiatan sekolah</a>
                </div><br>
