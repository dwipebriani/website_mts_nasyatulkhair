...
$query =mysqli_query($koneksi, "SELECT * FROM tbl_ekstrakulikuler where id_ekstrakulikuler='$id_ekstrakulikuler'
             ");
...
$ubah = mysqli_query($koneksi, "UPDATE tbl_ekstrakulikuler SET judul='$judul', keterangan='$keterangan'  WHERE id_ekstrakulikuler='$id_ekstrakulikuler'");
...
$ubah = mysqli_query($koneksi, "UPDATE tbl_ekstrakulikuler SET judul='$judul', keterangan='$keterangan', foto='$file_name'WHERE id_ekstrakulikuler='$id_ekstrakulikuler'");
 }
