          ...
          <div class="table-responsive">
            ...
            <form method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label>Foto</label>
                <input type="file" name="fotoo" required="">
              </div>
...
$file_name = $_FILES['fotoo']['name'];
$sourc = $_FILES['foto']['tmp_name'];
$folder = '../img/';
move_uploaded_file($sourc,$folder.$file_name);


$tambah = mysqli_query($koneksi, "INSERT INTO tbl_osis VALUES('','$judul','$keterangan','$file_name')");
