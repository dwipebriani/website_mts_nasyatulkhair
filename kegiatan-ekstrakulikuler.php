<?php   
include 'config.php'; 
$ekstra= mysqli_query($koneksi, "SELECT * FROM tbl_ekstrakulikuler");
...
<head>
    ...
    <title>Kegiata-ekstrakulikuler</title>
    <!-- Bootstrap CSS -->
...
<body class="body">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            ...
                            <p>Beberapa Ekstrakurikuler, diantaranya adalah <br>Pramuka <br>Futsal <br>Baca & Tulis Al Qur'an<br>hadroh<br>Silat<br>Paskibra<br>PMR</p>
    ...
    <div class="popular_courses lite_bg">
        <div class="container">
            ...
            <div class="row">
                <!-- single course -->
<?php while($ekstra1 =mysqli_fetch_assoc($ekstra)):  ?> 

                <!-- single course -->
                <div class="col-lg-3 col-md-6">
                    <div class="single_course">
                        <div class="course_head overlay">
                            <img class="img-fluid w-100" src="backend/img/<?=$ekstra1['foto']; ?>" width='180' height='150'>
                            
                        </div>
                        <div class="course_content">
                            <h4>
                                <a href="#"><?=$ekstra1['judul']; ?></a>
                            </h4>
                            <p><?=$ekstra1['keterangan']; ?></p>
